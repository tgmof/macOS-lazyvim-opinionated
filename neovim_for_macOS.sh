...
if [ -d /Applications/Alacritty.app ]; then
  ...
  echo "You MAY want to run the following lines to use the fonts installed by this script and default alacritty options:"
  echo "mkdir -p ~/.config/alacritty/"
  echo "cp ./alacritty.toml ~/.config/alacritty/alacritty.toml"
else
